...
export function ReportingTrendChart({ trends }: { trends: MelReportingDataset["trends"] }) {
  ...
  return (
    <div className="h-80 w-full" role="img" aria-label="Monthly median revenue, monthly median profit, and jobs trend by reporting period">
      <ResponsiveContainer width="100%" height="100%">
        <ComposedChart data={trends} margin={{ top: 12, right: 12, left: 12, bottom: 8 }}>
          ...
          <Legend />
          <Bar yAxisId="money" dataKey="revenue" name="Monthly median revenue" fill="oklch(0.67 0.14 230)" radius={[3, 3, 0, 0]} />
          <Line yAxisId="money" type="monotone" dataKey="profit" name="Monthly median profit" stroke="oklch(0.52 0.14 150)" strokeWidth={2} dot={false} />
