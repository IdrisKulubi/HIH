  ...
  if (!reviewRes.success || !reviewRes.data) {
    return (
      <div className="container mx-auto px-4 py-8">
        ...
        <Link href="/oversight" className="mt-4 inline-block text-sm text-emerald-700 hover:underline">
          Back to hub
        </Link>
      </div>
    );
      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
        <div>
          ...
          <p className="mt-2 max-w-2xl text-sm text-slate-600">
            REDO review of logged mentorship sessions. Confirm the date and duration, then approve
            or return them to the mentor.
          </p>
        </div>
      </div>
